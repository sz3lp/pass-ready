...
export const PRACTICE_TESTS: PracticeTest[] = [
  {
    ...
    unit: "Block I",
    kind: "block",
    subtitle: "70 Q · Ch. 1, 5, 6, 8, 10, 11, 13, 14, 25–29",
    when: "Thu Sep 24 · 1800–1930 · 90 min · miss ≤14",
    chapters: BLOCKS[0].examChapters,
    target: 70,
    minutes: 90,
    passLine: 80,
    gate: "Cadre: 70 MCQ, national standards (not KC). MOST/BEST/EXCEPT. Scene safe → life threats → sick/not sick. Feeds the 80% bench.",
  },
  {
    id: "q1",
    label: "Quiz 1",
  ...
  },
  {
    ...
    unit: "Crew bank",
    kind: "final",
    subtitle: "120 real TestPrep items from your screen recordings",
